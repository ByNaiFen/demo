...
//        try {
//            generator("ysk",//作者
//                    "jdbc:mysql://43.134.94.171:3306/employee?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai",
//                    "com.mysql.cj.jdbc.Driver",//数据库驱动
//                    "root",//数据库帐号
//                    "123456",//数据库密码
//                    "com.example.employeeadmin.demos",//项目最大的包名
//                    "employee-admin",//项目名或项目模块名
//                    "code");//要操作的表名,多个表名用逗号隔开
...
//        //各个包目录起名
//        packageConfig.setEntity("domains.po");
